...
it( 'Should localize without transformations', () =>
{
	...
	assert.equal( localization.get( 'es', 'foo.bar'), undefined );
	assert.equal( localization.get( 'en', 'foo.bar.goo'), undefined );
	...
	assert.equal( localization.get( 'en', 'foobar'), undefined );
	assert.equal( localization.get( 'en', 'foobar', 'bar.foo'), 'bar.foo.en' );
	assert.equal( localization.get( 'en', 'foobar', 'barfoo'), undefined );
});
